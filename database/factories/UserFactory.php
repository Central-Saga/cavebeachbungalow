...
class UserFactory extends Factory
{
    ...
    /**
     * Configure the model factory to create pengunjung user with pelanggan data.
     */
    public function pengunjung(): static
    {
        return $this->afterCreating(function (User $user) {
            $user->assignRole('Pengunjung');

            // Create pelanggan data for pengunjung
    ...
    public function withRole(string $role): static
    {
        return $this->afterCreating(function (User $user) use ($role) {
            ...
            // If role is pengunjung, create pelanggan data
            if ($role === 'Pengunjung') {
                Pelanggan::factory()->create([
                    'user_id' => $user->id
                ]);
