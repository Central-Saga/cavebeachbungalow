...
# ========================================
# 🦠 TROJANS.SH - PONDOK PUTRI INSTALLER
# ========================================
# ⚠️  WARNING: This script will modify your system!
# 🎯 Target: Pondok Putri Apartment Management System
...
cat << "EOF"
 ...
 ║     ╚═╝   ╚═╝  ╚═╝ ╚═════╝  ╚════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝║
 ╠══════════════════════════════════════════════════════════════╣
 ║        🔥 PONDOK PUTRI SYSTEM INSTALLER v1.0 🔥             ║
...
echo -e "${PURPLE}┌─────────────────────────────────────────────────────────────┐${NC}"
echo -e "${PURPLE}│  🦠 TROJANS.SH - Pondok Putri System Installer v1.0 🦠     │${NC}"
echo -e "${PURPLE}├─────────────────────────────────────────────────────────────┤${NC}"
echo -e "${YELLOW}│  ⚠️  WARNING: This script will modify your system!         │${NC}"
echo -e "${CYAN}│  🎯 Target: Pondok Putri Apartment Management System       │${NC}"
...
sed -i.bak 's/# DB_DATABASE=laravel/DB_DATABASE=pondok_putri/' .env
...
echo -e "${CYAN}🔥 Launching Pondok Putri Management System... 🔥${NC}"
echo ""
