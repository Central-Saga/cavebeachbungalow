...
mount(function($id) {
    if (auth()->check() && auth()->user()->pelanggan) {
        $this->reservasi = Reservasi::with(['kamar.tipeKamar', 'pembayarans', 'pelanggan'])
            ->where('id', $id)
...
$selectReservasi = function() {
    $this->nominal = $this->reservasi->sisa_bayar;
            ...
            <div class="relative z-10 container mx-auto px-4 py-16">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <nav class="flex items-center justify-center gap-2 text-sm text-slate-600 mb-6">
                        ...
                        <span class="text-slate-400">/</span>
                        <span class="text-slate-600">Detail Reservasi</span>
                    </nav>
        ...
        <div class="bg-white">
            <div class="container mx-auto px-4 py-16">
                    ...
                    <div class="bg-white border border-slate-200 rounded-xl shadow-sm">
                        ...
                        <div class="px-6 py-4 border-b border-slate-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h2 class="text-2xl font-bold text-[#133E87]">{{ $reservasi->kode_reservasi }}</h2>
                        ...
                        <div class="px-6 py-4">
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h4 class="font-semibold text-[#133E87] mb-3">Informasi Reservasi</h4>
                                ...
                                <div>
                                    <h4 class="font-semibold text-[#133E87] mb-3">Status Pembayaran</h4>
                                    <div class="space-y-3">
                            ...
                            <div class="mt-6 pt-4 border-t border-slate-200">
                                <h4 class="font-semibold text-[#133E87] mb-3">Riwayat Pembayaran</h4>
                                <div class="space-y-2">
                            ...
                            <div class="mt-6 pt-4 border-t border-slate-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <button wire:click="selectReservasi"
                ...
                <div class="text-center py-16">
                    ...
                    <h3 class="text-2xl font-bold text-[#133E87] mb-4">Reservasi Tidak Ditemukan</h3>
                    <p class="text-slate-600 mb-6">Reservasi yang Anda cari tidak ditemukan atau Anda tidak memiliki
                        akses.</p>
                    <a href="{{ route('landingpage.reservasi-saya') }}"
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-[#133E87]">Upload Bukti Pembayaran</h3>
            ...
            <form wire:submit.prevent="uploadBuktiPembayaran">
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" wire:model="nominal" min="1000" step="1000"
