...
<div class="flex flex-col gap-6">
    ...
    <form wire:submit="register" class="flex flex-col gap-6">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <!-- Left Column -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-[#133E87] border-b-2 border-[#133E87]/20 pb-2">{{ __('Personal
                    Information') }}</h3>
            ...
            <!-- Right Column -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-[#133E87] border-b-2 border-[#133E87]/20 pb-2">{{ __('Additional
                    Details') }}</h3>
                ...
                <!-- City -->
                <flux:input wire:model="kota" :label="__('City')" type="text" required autocomplete="address-level2"
                    :placeholder="__('Jakarta')" />
                ...
                <!-- Date of Birth -->
                <flux:input wire:model="tanggal_lahir" :label="__('Date of Birth')" type="date" required
                    autocomplete="bday" />
            </div>
        </div>
